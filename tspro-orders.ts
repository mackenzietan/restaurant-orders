/*the following code exports the enumerator PriceBracket, which is a type that can be used with Low, Medium, or High through dot notation
*/
...
/*the following code exports the Order type alias as it conforms to the orders type defined here in this file
*/
